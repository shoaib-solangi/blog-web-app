...
const  handlePostSubmit = async()=> {
  try {
    ...
    let imageUrl = "";
    if (blogImage) {
      const imageRef = ref(storage, `blogImage/${blogTitle}`);
    ...
    <div className="flex justify-center min-h-screen bg-blueGray-800">
      <div className="bg-blueGray-900 p-6 rounded-lg shadow-md w-full max-w-lg">
        ...
        <label className="block mb-4">
          ...
          <label className="block mb-4 mt-2">
            ...
            <Select onValueChange={(value)=>{setBlogCateg(value)}}>
              <SelectTrigger             className="mt-2 w-[600px] max-w-full p-2 border border-blueGray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
              >
        ...
        <label className="block mb-4">
          ...
          type="file"
            className="mt-2 w-[600px] max-w-full p-2 text-white border border-blueGray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
